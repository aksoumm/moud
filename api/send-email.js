// api/send-email.js
// Appelée par GitHub Actions à 21h → envoie l'email avec 5 boutons mood

const RESEND_KEY    = process.env.RESEND_API_KEY;
const TO_EMAIL      = process.env.TO_EMAIL;          // ton adresse
const FROM_EMAIL    = process.env.FROM_EMAIL;        // ex: moud@tondomaine.com
const APP_URL       = process.env.APP_URL;           // ex: https://ton-username.github.io/moud
const API_URL       = process.env.API_URL;           // ex: https://moud.vercel.app
const API_SECRET    = process.env.API_SECRET;
const CRON_SECRET   = process.env.CRON_SECRET;       // secret pour que seul GitHub Actions puisse appeler
...
<body style="margin:0;padding:0;background:#0e0c1a;font-family:'Helvetica Neue',Helvetica,sans-serif">
  <div style="max-width:400px;margin:0 auto;padding:40px 24px">

    <!-- Header -->
    <div style="text-align:center;margin-bottom:32px">
      <div style="font-size:28px;font-weight:800;color:#f0eeff;letter-spacing:-.02em">Moud</div>
...
export default async function handler(req, res) {
  ...
  // Vérifier que l'appel vient bien de GitHub Actions
